...
int main (int argc, char *argv[])
{
  ...
  //Elijo el algoritmo de congestión de TCP Westwood
  Config::SetDefault ("ns3::TcpL4Protocol::SocketType", StringValue ("ns3::TcpWestwood"));//TcpWestwood//TcpHighSpeed//TcpHybla//TcpNewReno
